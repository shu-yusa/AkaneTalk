...
final class AkaneTalkCanvas extends Canvas
    ...
    //コマンド
    //--------------------
    private Command cmdMode =new Command("ﾓｰﾄﾞ",Command.SCREEN,0);
    private Command cmdKaiso=new Command("ｶｲｿｳ",Command.SCREEN,1);
            ...
            if (scene==S_TALK) {
                ...
                //--------------------
                    ...
                    if (akaneTypeN!=akaneType) {
                        ...
                        drawBox(HEIGHT-92,88);
                        graOff.drawString(strs[1],10,HEIGHT-86,L_T);
                        graOff.drawImage(resImg[8],(WIDTH-194)/2,HEIGHT-34,L_T);
                ...
                if (charPos<=3) { //mark
                  if (fe.startsWith("fe8_b") || fe.startsWith("fe8_c")) {
                    ...
                    graOff.setColor(0,0,0);
                    graOff.fillRect(0,23,WIDTH,25);
                    graOff.fillRect(0,174,WIDTH,268);
                  }
                  graOff.drawImage(charImg[charPos],0,0,L_T);
                } else {
                    graOff.setColor(charPos-10);
                    graOff.fillRect(0,0,240,268);
                }
                drawMode();
...
//====================
        if (scene==S_TITLE) {
            ...
            graOff.setColor((255<<16)+(255<<8)+255);
            graOff.fillRect(0,0,WIDTH,HEIGHT);
            graOff.drawImage(resImg[9],WIDTH-232,HEIGHT-168,L_T);
            graOff.drawImage(resImg[2],(WIDTH-154)/2,11,L_T);
            if (tick%16<8) graOff.drawImage(resImg[3],14,HEIGHT-24,L_T);
        ...
        if (scene==S_TALK || (scene>=S_BUTTON && tick%50==0)) {
            ...
            if (!pause) {
                ...
                //--------------------
                    ...
                    graOff.fillRoundRect(12,HEIGHT-85+key*26,
                        Math.min(talk[key*2].getBytes().length*12,220),24,5,5);
                    graOff.setColor((255<<16)+(255<<8)+255);
                    for (i=0;i<talk.length/2;i++) {
                        graOff.drawString(talk[i*2],12,HEIGHT-83+i*26,L_T);
                    }
                }
                //トーク
                //--------------------
                    ...
                    if (talkPos<20) {
                        ...
                        graOff.drawString(talk[0],12,HEIGHT-83,L_T);
                        ...
                        graOff.drawString(talk[0],12,HEIGHT-83,L_T);
                        graOff.drawString(talk[1],12,HEIGHT-83+26,L_T);
                        ...
                        if (talk.length>=2)
                            graOff.drawString(talk[1],12,HEIGHT-83+26,L_T);
                        if (talk.length>=3)
                            graOff.drawString(talk[2],12,HEIGHT-83+52,L_T);
                    }
                }
                //回想モード
                //--------------------
                else if (scene==S_KAISOU) {
                    drawBox(HEIGHT-236,87+70*2);
                    graOff.setColor((255<<16)+(130<<8)+130);
                    graOff.fillRoundRect(12,HEIGHT-240+14+key*26,
                        (int)(talk[key*2].getBytes().length*2.5),26,5,5);
                    graOff.setColor((255<<16)+(255<<8)+255);
                    for (i=0;i<talk.length/2;i++) {
                        graOff.drawString(talk[i*2],12,HEIGHT-240+16+i*26,L_T);
                    }
                }
            }
        }
...
//====================
    ...
    private void drawBox(int top, int h) {
      ...
      graOff.fillRoundRect(6,top,228,h,20,20);
      graOff.setColor(113,171,254);
      graOff.fillRoundRect(6+1,top+1,226,h-2,20,20);
      graOff.setColor(103,155,255);
      graOff.fillRoundRect(6+2,top+2,224,h-4,20,20);
      graOff.setColor(102,140,255);
      graOff.fillRoundRect(6+3,top+3,222,h-6,20,20);
      graOff.setColor(110,125,254);
      graOff.fillRoundRect(6+4,top+4,220,h-8,20,20);
      graOff.setColor(113,116,255);
      graOff.fillRoundRect(6+5,top+5,218,h-10,20,20);
      graOff.setColor(107,110,254);
      graOff.fillRoundRect(6+6,top+6,216,h-12,20,20);
    ...
    private void drawMode() {
        ...
        if (mode!=0) {
            ...
            //--------------------
            if (mode==1) {
//              graOff.drawString(new String(
//                  new char[]{0xE022}),WIDTH-4-5*12,4,L_T);
                str=c(friend,3);
                String str0=c(friend,3);
                int posX = WIDTH-4-FONT_TYPE.stringWidth("000");
                int posY = 4 + FONT_TYPE.getHeight()/2;
                graOff.drawImage(resImg[7],posX-16-4,posY-13/2,L_T);
        ...
        while (scene>=0) {
            try {
                ...
                if (control==C_READY0) {
                    ...
                    graOff.fillRect(20,HEIGHT-14,tick*2,4);
                    repaint();
                }
                //タスクバー終了
                //--------------------
                ...
                //--------------------
                    ...
                    if (charPos==0) {
                        ...
                        graOff.drawImage(charBuf[charPos],0,0,L_T);
                    }
